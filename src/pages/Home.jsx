...
const Home = () => {
  ...
  // Sirf upcoming + live events popup mein dikhao
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="text-sm md:text-lg leading-relaxed text-gray-400 font-medium">
              <p className="mb-6">
                At{" "}
                <span className="text-orange-500 font-bold">Evolvera</span>
                , we're not just building projects — we're shaping the future.
              </p>
