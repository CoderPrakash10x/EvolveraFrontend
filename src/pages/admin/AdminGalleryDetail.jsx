...
import { ArrowLeft, ImagePlus, Trash2, Images } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="relative rounded-2xl overflow-hidden h-56 max-w-lg border border-white/10">
          <img src={gallery.cover.url} className="w-full h-full object-cover" />
      ...
      <div className="bg-zinc-900 border border-white/10 rounded-2xl p-6 max-w-lg space-y-5">
        ...
        {previews.length > 0 && (
          <div className="grid grid-cols-4 gap-2">
            {previews.map((p, i) => (
              <img key={i} src={p} className="h-16 w-full object-cover rounded-lg border border-white/10" />
            ))}
          </div>
        )}
